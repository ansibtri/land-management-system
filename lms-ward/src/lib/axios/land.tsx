...
export { registerLand, getLandsByUserId, verifyOTPandSellProcess, getLandById, verifyLandByWardOfficer, updateLandStatus, getAllLandsOfArea, getLandsWhichIsAvailableForSell }